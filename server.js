...
var passport = require('passport'); //express-session paka unadali
var LocalStrategy = require('passport-local').Strategy; //oauth tool for google and facebook

var cookieParser = require('cookie-parser'); ///cookkies read cheyadNIKI

mongoose.connect('mongodb://manasa93:manasa123@ds055626.mlab.com:55626/meetupplanner');
var app = express();
...
var morgan = require('morgan'); //LOGAR request read
...
var User = mongoose.model('meet4', userSchema); //node use chesukovadani ki
